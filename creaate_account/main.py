...
profile.set_preference("general.useragent.override",
                       "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_5) AppleWebKit/537.36 (KHTML) Chrome/83.0.4103.97 Safari/537.36")
...
if auto_email == "true":
    ...
    post_response = requests.post("https://lazy-mail.com/mailbox/create/random", data=post_data,
...
if auto_email == "true":
    while (True):
        ...
        if "Verification Code" not in get_emails.text:
            ...
            get_code = \
            get_emails.text.split("ext\":\"To verify your account, enter this code in TikTok:<br\/>")[1].split("\"")[0]
            break
